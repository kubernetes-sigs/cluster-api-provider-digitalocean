...
import (
	...
	"sigs.k8s.io/cluster-api-provider-digitalocean/pkg/controller"
	"sigs.k8s.io/cluster-api/pkg/apis/cluster/common"
	"sigs.k8s.io/controller-runtime/pkg/client/config"
	"sigs.k8s.io/controller-runtime/pkg/manager"
	"sigs.k8s.io/controller-runtime/pkg/runtime/signals"

	"sigs.k8s.io/cluster-api-provider-digitalocean/pkg/apis"
...
func main() {
	...
	machine.MachineActuator, err = machine.NewMachineActuator(machine.ActuatorParams{
		...
		EventRecorder:            mgr.GetRecorder("digitalocean-controller"),
