...
create-management-cluster: $(KUSTOMIZE) $(ENVSUBST)
	...
	# Deploy CAPI
	curl --retry $(CURL_RETRIES) -sSL https://github.com/kubernetes-sigs/cluster-api/releases/download/v1.0.5/cluster-api-components.yaml | $(ENVSUBST) | kubectl apply -f -
