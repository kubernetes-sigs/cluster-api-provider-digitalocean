...
// +k8s:conversion-gen=sigs.k8s.io/cluster-api-provider-digitalocean/pkg/apis/doproviderconfig
// +k8s:openapi-gen=true
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "doproviderconfig.k8s.io", Version: "v1alpha1"}
	// SchemeBuilder collects functions that add things to a scheme.
	SchemeBuilder = &scheme.Builder{GroupVersion: SchemeGroupVersion}
)

func init() {
	SchemeBuilder.Register(&DigitalOceanMachineProviderConfig{})
}
...
func (codec *DigitalOceanProviderConfigCodec) DecodeFromProviderConfig(providerConfig clusterv1.ProviderSpec, out runtime.Object) error {
...
func (codec *DigitalOceanProviderConfigCodec) EncodeToProviderConfig(in runtime.Object) (*clusterv1.ProviderSpec, error) {
