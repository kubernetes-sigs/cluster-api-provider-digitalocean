...
// Source: sigs.k8s.io/cluster-api-provider-digitalocean/cloud/services/computesenhanced (interfaces: DropletsService)
//
// Generated by this command:
//
//	mockgen -destination droplets_mock.go -package mock_computesenhanced sigs.k8s.io/cluster-api-provider-digitalocean/cloud/services/computesenhanced DropletsService
//

// Package mock_computesenhanced is a generated GoMock package.
package mock_computesenhanced
...
import (
	...
	computesenhanced "sigs.k8s.io/cluster-api-provider-digitalocean/cloud/services/computesenhanced"
)
...
// CreateWithAffinity mocks base method.
func (m *MockDropletsService) CreateWithAffinity(tx context.Context, req *godo.DropletCreateRequest, antiAffinityKey string) (*computesenhanced.DropletCreateWithAntiAffinityResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateWithAffinity", tx, req, antiAffinityKey)
	ret0, _ := ret[0].(*computesenhanced.DropletCreateWithAntiAffinityResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateWithAffinity indicates an expected call of CreateWithAffinity.
func (mr *MockDropletsServiceMockRecorder) CreateWithAffinity(tx, req, antiAffinityKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateWithAffinity", reflect.TypeOf((*MockDropletsService)(nil).CreateWithAffinity), tx, req, antiAffinityKey)
}
